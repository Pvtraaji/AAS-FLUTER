...
import 'package:projectlagi/Widgets/DrawerWidget.dart';
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text("Coba dan rasakan!", style: TextStyle(fontSize: 14),
                                ),
                                Text("\$15", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.green),
                                ),
                              ]
                            ),
                          ),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              mainAxisAlignment: MainAxisAlignment.spaceAround,
                              children: [
                                Text("Sate Tikus", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),
                                ),
                                Text("Coba dan rasakan!", style: TextStyle(fontSize: 14),
                                ),
                                Text("\$15", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.green),
                        ...
                        children: [
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Text("\$90", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold, color: Colors.green),
                              ),
                             ],
                            ),
                          ),
